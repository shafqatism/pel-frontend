...
export const fleetApi = {
  vehicles: {
    ...
    importBulk: (dtos: Partial<CreateVehicleDto>[]) =>
      api.post<{ count: number }>("/fleet/vehicles/bulk", dtos).then(r => r.data),
  ...
  trips: {
    ...
    importBulk: (dtos: Partial<CreateTripDto>[]) =>
      api.post<{ count: number }>("/fleet/trips/bulk", dtos).then(r => r.data),
  ...
  fuel: {
    ...
    importBulk: (dtos: Partial<CreateFuelLogDto>[]) =>
      api.post<{ count: number }>("/fleet/fuel/bulk", dtos).then(r => r.data),
  ...
  maintenance: {
    ...
    importBulk: (dtos: Partial<CreateMaintenanceDto>[]) =>
      api.post<{ count: number }>("/fleet/maintenance/bulk", dtos).then(r => r.data),
  ...
  assignments: {
    ...
    importBulk: (dtos: Partial<CreateAssignmentDto>[]) =>
      api.post<{ count: number }>("/fleet/assignments/bulk", dtos).then(r => r.data),
  ...
  reports: {
    ...
    export: (type: string, format: string) =>
      api.get(`/fleet/export/${type}`, { params: { format }, responseType: 'blob' }),
  },
}
