...
const emptyAsUndefined = (val: any) => (val === "" ? undefined : val)
...
const schema = z.object({
  ...
  assignedSite: z.string().optional().nullable().or(z.literal("")),
  currentDriverName: z.string().optional().nullable().or(z.literal("")),
  currentOdometerKm: z.preprocess((val) => {
  ...
  return (
    <form onSubmit={handleSubmit(v => mutate(v))} className="space-y-4">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          <Label>Year</Label>
          <Input type="number" {...register("year")} placeholder="e.g. 2022" />
        ...
        <div className="space-y-1.5">
          ...
          {errors.currentOdometerKm && <p className="text-xs text-destructive">{errors.currentOdometerKm.message}</p>}
        </div>
        <div className="space-y-1.5">
      ...
      <div className="pt-4 border-t">
        <Label className="text-base font-semibold">Documents & Pictures</Label>
        <p className="text-sm text-muted-foreground mb-4">Upload registration documents, insurance, or vehicle photos.</p>
