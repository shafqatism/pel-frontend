  ...
  return (
    <form onSubmit={handleSubmit(v => mutate(v))} className="space-y-4">
      ...
      <div className="pt-4 border-t">
        <Label className="text-base font-semibold">Assignment Documents & Handover Photos</Label>
        <p className="text-sm text-muted-foreground mb-4">Upload signed handover forms or photos of the vehicle condition.</p>
