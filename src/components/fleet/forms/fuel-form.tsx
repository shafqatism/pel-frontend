  ...
  return (
    <form onSubmit={handleSubmit(v => {
      ...
      <div className="pt-4 border-t">
        <Label className="text-base font-semibold">Fuel Receipts & Images</Label>
        <p className="text-sm text-muted-foreground mb-4">Upload fuel receipts or photos of the meter for verification.</p>
