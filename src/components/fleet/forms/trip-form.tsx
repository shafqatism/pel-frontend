  ...
  return (
    <form onSubmit={handleSubmit(v => mutate(v))} className="space-y-6">
      ...
      <div className="pt-4 border-t">
        <Label className="text-xs font-bold uppercase tracking-wider text-muted-foreground block mb-2">Journey Media</Label>
        <p className="text-xs text-muted-foreground mb-4">Attach receipts, route photos, or documents related to this trip.</p>
